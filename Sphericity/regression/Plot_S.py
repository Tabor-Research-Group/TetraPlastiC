...
for i in range(100):
    ...
    with open(f'S/{i}/models/top0100_D002', 'r') as model_file,          open(f'H/{i}/SIS_subspaces/Uspace.expressions', 'r') as feature_space,          open(f'./feature_name_{i}', "rb") as fp:
...
plt.title('Selected Descriptors Ratio from Entropy Prediction')
plt.legend()
plt.savefig('Selected Descriptors Ratio from Entropy Prediction.png',dpi=300)
